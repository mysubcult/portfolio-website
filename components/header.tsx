  ...
  return (
    <header className="z-[999] relative">
      ...
      <nav className="flex fixed top-[0.2rem] left-1/2 h-14 -translate-x-1/2 py-2 sm:top-[1.8rem] sm:h-[initial] sm:py-0">
        <ul className="flex w-full max-w-[43rem] flex-wrap items-center justify-center gap-y-1 text-[1.1rem] font-medium text-gray-500 sm:w-[initial] sm:flex-nowrap sm:gap-6">
          {links.map((link) => (
            <motion.li
